...
def renderEditWindow(selectedStudData):
    ...
    editCanvas.create_text(35.0,339.0,anchor="nw",text="Address",fill="#000000",font=("Inter", 11 * -1))
...
mainCanvas.create_text(73.0,15.0,anchor="nw",text="Student  Management System",fill="#FFFFFF",font=("Inter SemiBold", 36 * -1))
